...
def main():
    ...
    build_qdrant_index(
        ...
        model_name=EMBEDDING_MODEL,   # <-- passes the model name to the builder
        dim=EMBEDDING_DIM,             # <-- vector dimension (e.g., 768)
        batch_size=128,                # you can tune this later if needed
    )
